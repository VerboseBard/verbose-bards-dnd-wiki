...
The extracted [War of the Gods, Session 19](../sessions/war-of-the-gods-session-19.md) complicates the simple "restore it and everything is fixed" version of this history. In [Alen](../people/alen.md)'s telling, an earlier dungeon-core and ley-line network already existed before the [Breaking](the-breaking.md), and restoring that full planetary or multi-world system without accounting for how the fractured worlds now overlap could cause another mass-casualty catastrophe when landmasses and populations try to recombine.

In [War of the Gods, Session 22](../sessions/war-of-the-gods-session-22.md), that theory becomes concrete. The party witnesses one active reconstruction node rise from the ground after a ritual involving stretched soul-energy, purple crystals, and dungeon-linked ley power. The resulting structure behaves less like a symbolic shrine and more like a functional gate segment: spinning runes, liquid mana wells, and multiple dungeon channels feeding a nexus that the party concludes they cannot realistically destroy.
...
Before the Gate, magic users were rarer but could reach much higher power. After the Gate, magic is more accessible but less individually limitless. Scholars theorize that more people can touch magic now, but fewer can become world-shaking casters without artificery or ritual supplementation.

Session-17 discussion also frames this in terms of magical "pressure." Mortals adapted to a high-density magical world might survive a gradual drop, but divine or near-divine beings at the top end would be forced outward first.
