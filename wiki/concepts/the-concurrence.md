...
The Concurrence is the event that linked multiple worlds into the current known order.

## Description

Before the Concurrence, the worlds were separated or inaccessible in their current form. Afterward, travel, politics, war, and trade became interworld affairs. The Concurrence also coincides with major changes in magic access and divine structure.

[Greg's Concurrence Proposal](gregs-concurrence-proposal.md) frames the event as a controlled convergence rather than a collision. In that model, each world is surveyed, anchored through magical conduits, and tuned to a shared metaphysical resonance centered on the [Radiant Citadel](../places/radiant-citadel.md).

## Consequences

The linked worlds enabled the [Unified Armed Forces](../factions/unified-armed-forces.md), broadened the scale of [the Kreen War](kreen-war.md), and made hubs like [Unity](../places/unity.md) and the [Radiant Citadel](../places/radiant-citadel.md) essential.
