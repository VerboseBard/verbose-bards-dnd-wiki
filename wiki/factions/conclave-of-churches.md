# Conclave of Churches

The Conclave of Churches is a major religious and political bloc in the post-[Concurrence](../concepts/the-concurrence.md) world order.

## Description

The Conclave coordinates religious authority across linked worlds. Its militant and investigative arms can overlap with military operations, especially where corruption, heresy, divine law, or existential threats are involved.

The Conclave's earliest coordination begins before [the Concurrence](../concepts/the-concurrence.md) fully closes. Religious emissaries from worlds such as [Norvindr](../places/norvindr.md) are sent to prepare for a large gathering of faiths responding to the gods' departure behind the [Divine Gate](../concepts/divine-gate.md).

## Ecclesiastical Structure

The Conclave-aligned churches use an [Ecclesiastical Order](ecclesiastical-order.md) based on role, authority, and perception rather than simple spellcasting power. Exemplars, Divine Bloodline figures, Adjudicators, Inquisitors, Arbiters, Templars, Justicars, Zealots, Prophets, Wayfarers or Friars, Penitents, and Envoys each fill distinct social and theological functions inside the church.
...
At the [Jungle Ley-Line Facility](../places/jungle-ley-line-facility.md), a Conclave champion takes over the active ritual after [Winrah Holm](../people/winrah-holm.md) is freed from the mind-control crown. The Conclave champions continue into the [High Temple of Rexel Kar](../places/high-temple-of-rexel-kar.md), where Terrence counters a serpent suppression aura with his own divine support.

In the reconstructed [Moon Stone Collectors, Part 10](../sessions/moon-stone-collectors-part-10.md), [Saraphel of the Dawnfather](../people/saraphel-of-the-dawnfather.md) appears as reinforcement at [Ebonwing Manor](../places/ebonwing-manor.md) and destroys the Deceiver-linked enemy with divine retribution.

In [Moon Stone Collectors, Part 12](../sessions/moon-stone-collectors-part-12.md), [Terrence of Tyr](../people/terrence-of-tyr.md) is sent after the [Moon Stone Collectors](moon-stone-collectors.md) as a justicar. Rather than drag them back to the [Citadel](../places/radiant-citadel.md), he judges their intent regarding [Elisia](../people/elisia.md) and finds them innocent of wrongdoing.
