# Radiant Citadel Crystal

The Radiant Citadel Crystal is the immense crystal command structure at the heart of the [Radiant Citadel](radiant-citadel.md).

## Description

The crystal touches the upper and lower sides of [Unity](unity.md)'s hollow-world structure and rotates near the core. Its interior contains nonmagical staging, command, and transport spaces used by [Jarth](../people/jarth.md)'s forces and allied response teams.

In [Greg's Concurrence Proposal](../concepts/gregs-concurrence-proposal.md), [Citadel](radiant-citadel.md)-centered resonance is part of the theoretical mechanism that allowed worlds to converge without catastrophic destruction. The crystal is therefore not only infrastructure, but part of the [Citadel](radiant-citadel.md)'s larger stabilizing legacy.

## Suppression

Inside the crystal, divine influence and outside magic are strongly suppressed. This makes it an ideal place to contain dangerous soul fragments or interrogate enemies without divine interference, but it is uncomfortable or painful for beings who rely on divine connection.
