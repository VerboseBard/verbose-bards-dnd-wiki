...
Back at the hunting cabin after the hydra fight, [Juan](../people/juan.md) offers the [Amulet of Lost Memories](../items/amulet-of-lost-memories.md) to [Vylra](../people/vylra.md) and then [Zen](../people/zen.md), explaining that it can reveal memories but risks exhaustion and copies or stores memories from those who use it. Identify magic frames it as rare pre-Breaking dwarven runecraft built from divination and memory-copying effects rather than a simple dream charm.

[Juan](../people/juan.md) uses it again that night. He sees more of the old dwarven outbreak: the infected commander uses the three stone discs to open the moonlit cliff door, passes through traps and puzzles, and reaches a control chamber containing a massive gray ooze bound by cables and magical chains.

The ooze perceives the commander and impales him before he can activate the system that would kill all of it. [Juan](../people/juan.md) learns that the control room still exists and that two of the three keys have already been found.

## Phlukk and Viscus

That night, [Viscus](../people/viscus.md) reaches out to [Phlukk](../people/phlukk.md) in dreams. [Phlukk](../people/phlukk.md) experiences the grove through [Viscus](../people/viscus.md)'s roots, bees, plants, undead workers, and smokers consuming mushrooms.

[Viscus](../people/viscus.md) shows [Phlukk](../people/phlukk.md) that the grove is fed by eight [Fey](../concepts/fey.md)-linked mushroom circles. The destroyed Spring Court circle has left a wound. [Viscus](../people/viscus.md) directs [Phlukk](../people/phlukk.md) to another portal the party can use to seek repair.

## Paul and Julara

[Paul](../people/paul.md) receives an amulet from [Julara](../people/julara.md) that blocks or suppresses the [Crown of Fools](../items/crown-of-fools.md)'s faerie-fire effect.

[Julara](../people/julara.md) also tells [Paul](../people/paul.md) that the [Fey](../concepts/fey.md) gatekeeper's age curse stole 64 years from him, far more than a minor prank warranted and especially harsh for a minotaur's lifespan. She offers three possible answers: bind himself fully to her, force a [Fey](../concepts/fey.md) to give back what was taken, or be reborn through a child made with her and live again from there.
...
- Take a living piece of [Viscus](../people/viscus.md) into the old dwarven control room.
- Use it to infect or convert the master ooze.
- If the piece is destroyed, [Vylra](../people/vylra.md) or [Phlukk](../people/phlukk.md) may need to sacrifice themselves through their [Viscus](../people/viscus.md) connection to save Viscus.
- The fallback is destroying all goo, which would also kill [Viscus](../people/viscus.md).

[Vylra](../people/vylra.md) spends the night with the keepers, his grandfather, and the ancient Keeper cutting and preparing a living section of [Viscus](../people/viscus.md) for transport.

## Gateway Reopened

The party teleports back to the old [Gateway to the Empire](../places/gateway-to-the-empire.md) outpost. They search the bank, the well, and the barracks for the missing third disc.

[Zen](../people/zen.md)'s magic reveals hidden traps and the final key in the ruined barracks. With darkness and moonbeam, the cliffside door is revealed. The three discs are inserted and rotated in the correct order, and the hidden stairway opens.

The session ends as the party prepares to descend into the dwarven facility leading toward the control room.
