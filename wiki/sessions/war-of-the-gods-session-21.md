# Side Session: War of the Gods, Session 21

This side session continues directly from [War of the Gods, Session 20](war-of-the-gods-session-20.md) in the [War of the Gods](../concepts/war-of-the-gods.md) arc of the [War of the Gods / New Beginning Campaign](../campaign/war-of-the-gods.md).
...
- [Junara](../people/junara.md) enters the newborn dungeon alone, using speed, magic, and stealth to navigate through spawning undead and collapsing corridors while the others remain outside.
...
- More importantly, contact with the true core pulls him into a white void where it presents itself as a crying githyanki child terrified of being hurt and alone.
- [Junara](../people/junara.md) cannot determine with certainty whether this is the dungeon core's true nature or a manipulation designed to preserve itself, but he chooses to treat it as a frightened being rather than a mere object.
- Instead of destroying it, he persuades it to come willingly, and the core gives him a special bag of holding capable of containing it safely.
...
- During that rest, [Junara](../people/junara.md) explains what he learned: dungeon cores may be conscious entities, their dungeons may be defensive behavior rather than simple environmental hazards, and [Wendell](../people/wendell.md)'s whole strategy may involve manipulating beings the party barely understands.
...
- [Junara](../people/junara.md) argues for reinstating the Gate through a more ethical and controlled path than [Wendell](../people/wendell.md)'s current method, while still remaining deeply skeptical of all divine actors involved.
...
Session 21 changes the party's relationship to dungeon cores just as much as session 20 changed their relationship to [Belle](../people/belle.md). A dungeon is no longer just an enemy structure or magical machine in their minds. It may be a frightened intelligence, a manipulator, or both.

It also cements that the group's problem is no longer simply "stop [Wendell](../people/wendell.md)." Even if [Wendell](../people/wendell.md) dies, the party still has to choose what kind of world they want, which gods if any they can tolerate, and how much destruction they are willing to accept to rebuild the [Divine Gate](../concepts/divine-gate.md).

## Source Notes

Derived from the uploaded Session 21 transcript fragment for Hellsbane's heroes at the end of the [Sixth Age](../concepts/sixth-age.md), in the [War of the Gods / New Beginning Campaign](../campaign/war-of-the-gods.md). The session covers the aftermath of 69's disappearance, [Junara](../people/junara.md)'s solo dungeon-core retrieval, the revelation that dungeon cores may be conscious, and the party's extended debate over gods, sacrifice, and the [Divine Gate](../concepts/divine-gate.md).
