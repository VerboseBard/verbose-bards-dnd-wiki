# Side Session: War of the Gods, Session 22

This side session continues directly from [War of the Gods, Session 21](war-of-the-gods-session-21.md) in the [War of the Gods](../concepts/war-of-the-gods.md) arc of the [War of the Gods / New Beginning Campaign](../campaign/war-of-the-gods.md).
...
- Constance then learns the dragon hatchery has been struck. The wards are gone, the eggs have been stolen, several children are missing, and her mother is later found dead defending the site.
- One of Constance's young relatives has also been ritually sacrificed as part of [Wendell](../people/wendell.md)'s magical setup.
- At the ritual site, the party studies the altar, the soul-stretched ritual residue, and the purple crystals tied to the activation.
- Their interference causes the buried mechanism to finish assembling into a terrifying ley-line nexus: a multi-channel gate structure fed by spinning runes, liquid mana wells, and connections to several existing dungeons.
- The group realizes this is effectively one segment of the rebuilt [Divine Gate](../concepts/divine-gate.md), not just another battlefield trap, and that destroying it would require power on a scale they do not possess.
- Rose dies during [Wendell](../people/wendell.md)'s appearance and confrontation, leaving only her body and equipment behind.
- [Gregario / Shaq](../people/gregario-shaq.md), pushed by [Alen](../people/alen.md), claims Rose's holy gear from the body, including the champion's blade and other relics.
- [Wendell](../people/wendell.md) appears directly above the active nexus on his undead dragon, thanks Constance for helping complete the first step, and gloats that the ley lines on this world are now active and cannot easily be altered.
- During that exchange, Rose's last tie is severed and her soul is fed into the rising structure, making her death part of the new gate machinery rather than a simple battlefield casualty.
- [Mullin](../people/mullin.md) uses the moment to force [Wendell](../people/wendell.md) to magically obey the ridiculous command "touch your nose," proving that outside influence can still affect him and frightening [Wendell](../people/wendell.md) badly enough to make him flee.
- Instead of letting him escape cleanly, [Mullin](../people/mullin.md) secretly stows away on [Wendell](../people/wendell.md)'s dragon and rides with him long enough for a private negotiation.
...
- [Wendell](../people/wendell.md) gives [Mullin](../people/mullin.md) a crown that blocks gods and other powers from reading his mind.
- [Mullin](../people/mullin.md) then swears a binding ley-line oath: [Wendell](../people/wendell.md) will aid him in killing [Belle](../people/belle.md), and [Mullin](../people/mullin.md) will aid [Wendell](../people/wendell.md) against the Gate. The deal is magically locked and cannot be fully disclosed afterward.
...
Session 22 moves the [War of the Gods](../concepts/war-of-the-gods.md) arc from theory into structure. The party is no longer merely debating whether the [Divine Gate](../concepts/divine-gate.md) should be rebuilt. They have now watched one of its functional nodes come online, learned that it can be fed through ley-line and dungeon interactions, and realized that partial success may be more dangerous than total failure.

It also radically changes the personal map of the party. Constance finally gets the truth about her double prophecy, Rose is gone as an active companion, [Gregario](../people/gregario-shaq.md) becomes even more entangled with [Alen](../people/alen.md)'s logic, and [Mullin](../people/mullin.md) crosses into a private alliance that may matter as much as any public decision the party makes.
