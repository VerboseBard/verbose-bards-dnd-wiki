# War of the Gods, Session 5 (February 18, 2023)

This session begins the early desert-world field arc in the [War of the Gods / New Beginning Campaign](../campaign/war-of-the-gods.md).

## Overview

Dream unease gives way to field work. The party is now living in the Emerald Palace environment, researching older maps, tracking a missing mistress, and descending into a dangerous well that becomes its first serious off-campus dungeon-style test.
...
Session 5 is the first strong proof that the school is training the party for real field pressure, not safe exercises. It also starts the desert-world investigation thread that leads toward [Aylinn](../people/aylinn.md), [Wendell](../people/wendell.md), the mine, and the larger divine conflict.

## Source Notes

Derived from the February 18, 2023 entry in `C:\Users\bulld\Downloads\Kestrel notes.txt`.
