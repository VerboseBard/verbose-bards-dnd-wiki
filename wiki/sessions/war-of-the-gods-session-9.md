# War of the Gods, Session 9 (August 12, 2023)

This session pushes the campaign from school intrigue into open council-level crisis.
...
Session 9 turns the campaign political in a way it never really walks back from. Testimony, memory magic, and assassination-level escalation now sit beside training and character growth.

## Source Notes

Derived from the August 12, 2023 entry in `C:\Users\bulld\Downloads\Kestrel notes.txt`.
